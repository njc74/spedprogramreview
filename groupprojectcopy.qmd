...
Firstly, we set the two topics which represent negative and positive climate. TF-IDF was conducted with the whole survey data to boil down the negative and positive words by labeling with two kinds of questions: negative answers of "climate barriers" and "ineffective communications" questions, and positive answers about ”effective communications” and ”communication recommendations" questions.
...
In the coefficients analysis, the word "lack", "barrier", and "inconsistent" have the biggest impact for predicting the negative climate in the school workplace. Regarding the predictors for positive climate, "meeting" has meanings both negative and positive, yet it is more likely to be used in the positive context from this analysis. "Improve" sounds like a good predictor of positive climate; however, it only has a relatively small impact on positive climate.

For variable importance, "lack" is the best word in our survey data predicting negative climate. Term importance significantly decreases after "lack." "Enough" and "student" round out the top three, and are also predictors for negative climate.

As a whole, negative climate predictors received higher scores than predictors for positive climate. These scores indicate negative climate factors are less varied in school workplaces and could be easier to identify and eliminate than goals around creating positive climate.
