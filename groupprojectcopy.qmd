...
## What recommendations do you have for improving communication practices?
...
# Topic Modeling - Latent Dirichlet Allocation (LDA)
## Generating Topics with TF-IDF Analysis
Two topics representing generally "negative" and "positive" climates were set. TF-IDF was conducted with all respondent survey data and negative and positive responses were associated with two questions each; negative responses were associated with the "climate barriers" and "ineffective communication" questions, while positive answers were associated with ”effective communications” and ”communication recommendations" questions. All language was reviewed to ensure the model made accurate assignments. 
